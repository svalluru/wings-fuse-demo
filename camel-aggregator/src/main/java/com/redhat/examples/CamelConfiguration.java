...
public class CamelConfiguration extends RouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    //from("amqp:queue:processed?connectionFactory=#pooledJmsConnectionFactory&acknowledgementModeName=CLIENT_ACKNOWLEDGE")
	  //fromF("file:%s?readLock=fileLock&delete=false", "/Users/svalluru/tmp/josh_demo/camel-orders-demo/camel-aggregator/target/input")
	  from("kafka:processed-orders?brokers=localhost:9092&seekTo=beginning")
